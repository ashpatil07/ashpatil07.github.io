...
<button class="btn info" style="border-color: #2196F3; color: dodgerblue; background-color: white; padding: 14px 28px; font-size: 16px; cursor: pointer; margin-right: 10px;">Info</button>
```
